...
type ApplyPatchResponse_Result int32

const (
	ApplyPatchResponse_SUCCESS        ApplyPatchResponse_Result = 0
	ApplyPatchResponse_DOES_NOT_APPLY ApplyPatchResponse_Result = 1
	ApplyPatchResponse_ERROR          ApplyPatchResponse_Result = 2
)

var ApplyPatchResponse_Result_name = map[int32]string{
	0: "SUCCESS",
	1: "DOES_NOT_APPLY",
	2: "ERROR",
}
var ApplyPatchResponse_Result_value = map[string]int32{
	"SUCCESS":        0,
	"DOES_NOT_APPLY": 1,
	"ERROR":          2,
}

func (x ApplyPatchResponse_Result) String() string {
	return proto.EnumName(ApplyPatchResponse_Result_name, int32(x))
}
func (ApplyPatchResponse_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor9, []int{69, 0}
}
...
type ApplyPatchRequest struct {
	Repository *Repository `protobuf:"bytes,1,opt,name=repository" json:"repository,omitempty"`
	Branch     []byte      `protobuf:"bytes,2,opt,name=branch,proto3" json:"branch,omitempty"`
	Patches    []byte      `protobuf:"bytes,3,opt,name=patches,proto3" json:"patches,omitempty"`
}

func (m *ApplyPatchRequest) Reset()                    { *m = ApplyPatchRequest{} }
func (m *ApplyPatchRequest) String() string            { return proto.CompactTextString(m) }
func (*ApplyPatchRequest) ProtoMessage()               {}
func (*ApplyPatchRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{68} }

func (m *ApplyPatchRequest) GetRepository() *Repository {
	if m != nil {
		return m.Repository
	}
	return nil
...
func (m *ApplyPatchRequest) GetBranch() []byte {
	if m != nil {
		return m.Branch
	}
	return nil
...
func (m *ApplyPatchRequest) GetPatches() []byte {
	if m != nil {
		return m.Patches
	}
	return nil
...
type ApplyPatchResponse struct {
	Result ApplyPatchResponse_Result `protobuf:"varint,1,opt,name=result,enum=gitaly.ApplyPatchResponse_Result" json:"result,omitempty"`
}

func (m *ApplyPatchResponse) Reset()                    { *m = ApplyPatchResponse{} }
func (m *ApplyPatchResponse) String() string            { return proto.CompactTextString(m) }
func (*ApplyPatchResponse) ProtoMessage()               {}
func (*ApplyPatchResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{69} }

func (m *ApplyPatchResponse) GetResult() ApplyPatchResponse_Result {
	if m != nil {
		return m.Result
	}
	return ApplyPatchResponse_SUCCESS
}
...
func init() {
	...
	proto.RegisterType((*ApplyPatchRequest)(nil), "gitaly.ApplyPatchRequest")
	proto.RegisterType((*ApplyPatchResponse)(nil), "gitaly.ApplyPatchResponse")
	...
	proto.RegisterEnum("gitaly.ApplyPatchResponse_Result", ApplyPatchResponse_Result_name, ApplyPatchResponse_Result_value)
}
...
type RepositoryServiceClient interface {
	...
	ApplyPatch(ctx context.Context, opts ...grpc.CallOption) (RepositoryService_ApplyPatchClient, error)
}
...
func (c *repositoryServiceClient) ApplyPatch(ctx context.Context, opts ...grpc.CallOption) (RepositoryService_ApplyPatchClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RepositoryService_serviceDesc.Streams[10], c.cc, "/gitaly.RepositoryService/ApplyPatch", opts...)
	if err != nil {
		return nil, err
	}
	x := &repositoryServiceApplyPatchClient{stream}
	return x, nil
}

type RepositoryService_ApplyPatchClient interface {
	Send(*ApplyPatchRequest) error
	CloseAndRecv() (*ApplyPatchResponse, error)
	grpc.ClientStream
}

type repositoryServiceApplyPatchClient struct {
	grpc.ClientStream
}

func (x *repositoryServiceApplyPatchClient) Send(m *ApplyPatchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *repositoryServiceApplyPatchClient) CloseAndRecv() (*ApplyPatchResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type RepositoryServiceServer interface {
	...
	ApplyPatch(RepositoryService_ApplyPatchServer) error
}
...
func _RepositoryService_ApplyPatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RepositoryServiceServer).ApplyPatch(&repositoryServiceApplyPatchServer{stream})
}

type RepositoryService_ApplyPatchServer interface {
	SendAndClose(*ApplyPatchResponse) error
	Recv() (*ApplyPatchRequest, error)
	grpc.ServerStream
}

type repositoryServiceApplyPatchServer struct {
	grpc.ServerStream
}

func (x *repositoryServiceApplyPatchServer) SendAndClose(m *ApplyPatchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *repositoryServiceApplyPatchServer) Recv() (*ApplyPatchRequest, error) {
...
var _RepositoryService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _RepositoryService_ApplyPatch_Handler,
			ClientStreams: true,
		},
	},
...
var fileDescriptor9 = []byte{
	...
	,
}
